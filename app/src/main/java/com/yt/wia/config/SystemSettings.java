...
//    public static String UPLOADREQUEST_URL="http://192.168.1.103:8080/";//上传经纬度
    public static String CHARTREQUEST_URL="http://192.168.1.103:8080/mobilereport/";//报标地址

    //public static String UPLOADREQUEST_URL="http://192.168.1.115:80/manager/";//上传经纬度


    public static String UPLOADSHAPEREQUEST_URL="http://192.168.1.103:80/shp/";//下载shape文件地址
