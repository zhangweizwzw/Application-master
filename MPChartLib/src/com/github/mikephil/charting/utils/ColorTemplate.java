...
public class ColorTemplate {
     ...
     */
    public static final int COLOR_SKIP =Color.rgb(207, 248, 246);
    ...
    public static final int[] BAR_COLORS = {
            Color.rgb(99, 159, 169), Color.rgb(47, 69, 83), Color.rgb(195, 53, 49)
    };

    public static final int[] FOUR_COLORS = {
            Color.rgb(212, 130, 101), Color.rgb(145, 199, 174),Color.rgb(116, 116, 131),Color.rgb(202, 134, 134)
    };

    public static final int[] DQSCZZ_COLORS = {
           Color.rgb(47, 69, 83), Color.rgb(195, 53, 49)
    };
    ...
    public static final int[] SIMPLE_COLORS = {
            Color.rgb(192, 255, 140), Color.rgb(192, 255, 140), Color.rgb(192, 255, 140),
            Color.rgb(192, 255, 140), Color.rgb(192, 255, 140)
    };
